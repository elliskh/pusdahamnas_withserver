...
const load_datatable = () => {
	$('#datatable-wrapper').html(function (index, oldHtml) {
		let table =
	...
	datatable = $('#table-data').DataTable({
		...
		initComplete: async function () {
			...
			$(this).on('click', '.btn-update', function (event) {
				...
				let { id, kolom_1, kolom_2, kolom_3 } = data

				$('#form-ubah').data('id', id)
				$('#ubah-kolom_1').val(kolom_1)
				$('#ubah-kolom_2').val(kolom_2)
				$('#ubah-kolom_3').val(kolom_3)
...
const validator = {
	tambah: $('#form-tambah').validate({
		...
		messages: {
			kolom_1: "Kolom 1 tidak boleh kosong",
			kolom_2: "Kolom 2 tidak boleh kosong",
			kolom_3: "Kolom 3 tidak boleh kosong",
		}
	}),
