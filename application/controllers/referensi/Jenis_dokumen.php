...
{
	/**
	 * Jenis_dokumen constructor
	 */
	public function __construct()
	{
		parent::__construct();
		$this->_auth();
		$this->_path = 'referensi/jenis_dokumen/';
		$this->_table = 'ref_jenis_dokumen';
		//=========================================================//

		$this->load->model($this->_path . 'Jenis_dokumen_model', 'jenis_dokumen');
	}
	...
	public function index($menu_id = null)
	{
		...
		$config 			= [
			'title' 		=> 'Jenis Dokumen',
			'menu_id' 		=> $menu_id,
			'menu_active' 	=> 'Jenis Dokumen',
			'menu_open' 	=> 'Referensi',
			'path' 			=> $this->_path,
			'contents' 		=> $this->_path . 'index',
			'script_js' 	=> $this->_path . 'js',
			// =================================================
			'breadcrumb' => ['Pengaturan', 'Referensi', 'Jenis Dokumen', 'index'],
			'modals' => [
	...
	public function data($menu_id = null)
	{
		...
		$output = $this->jenis_dokumen->datatables();
		response($output);
	}
