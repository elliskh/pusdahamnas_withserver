...
class Fokus_lembaga extends MY_Controller
{
	/**
	 * Fokus_lembaga constructor
	 */
	public function __construct()
	{
		parent::__construct();
		$this->_auth();
		$this->_path = 'referensi/fokus_lembaga/';
		$this->_table = 'ref_fokus_lembaga';
		//=========================================================//

		$this->load->model($this->_path . 'Fokus_lembaga_model', 'fokus_lembaga');
	}
	...
	public function index($menu_id = null)
	{
		...
		$config 			= [
			'title' 		=> 'Fokus Lembaga',
			'menu_id' 		=> $menu_id,
			'menu_active' 	=> 'Fokus Lembaga',
			'menu_open' 	=> 'Referensi',
			'path' 			=> $this->_path,
			'contents' 		=>  $this->_path . 'index',
			'script_js' 	=> $this->_path . 'js',
			// =================================================
			'breadcrumb' => ['Pengaturan', 'Referensi', 'Fokus Lembaga', 'index'],
			'modals' => [
	...
	public function data($menu_id = null)
	{
		...
		$output = $this->fokus_lembaga->datatables();
		response($output);
	}
