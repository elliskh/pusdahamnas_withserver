...
{
	/**
	 * Badan_hukum constructor
	 */
	public function __construct()
	{
		parent::__construct();
		$this->_auth();
		$this->_path = 'referensi/badan_hukum/';
		$this->_table = 'ref_badan_hukum';
		//=========================================================//

		$this->load->model($this->_path . 'Badan_hukum_model', 'badan_hukum');
	}
	...
	public function index($menu_id = null)
	{
		...
		$config 			= [
			'title' 		=> 'Badan Hukum',
			'menu_id' 		=> $menu_id,
			'menu_active' 	=> 'Badan Hukum',
			'menu_open' 	=> 'Referensi',
			'path' 			=> $this->_path,
			'contents' 		=>  $this->_path . 'index',
			'script_js' 	=> $this->_path . 'js',
			// =================================================
			'breadcrumb' => ['Pengaturan', 'Referensi', 'Badan Hukum', 'index'],
			'modals' => [
	...
	public function data($menu_id = null)
	{
		...
		$output = $this->badan_hukum->datatables();
		response($output);
	}
