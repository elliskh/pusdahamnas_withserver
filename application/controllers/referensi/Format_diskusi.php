...
class Format_diskusi extends MY_Controller
{
	/**
	 * Format_diskusi constructor
	 */
	public function __construct()
	{
		parent::__construct();
		$this->_auth();
		$this->_path = 'referensi/format_diskusi/';
		$this->_table = 'ref_format_diskusi';
		//=========================================================//

		$this->load->model($this->_path . 'Format_diskusi_model', 'format_diskusi');
	}
	...
	public function index($menu_id = null)
	{
		...
		$config 			= [
			'title' 		=> 'Format Diskusi',
			'menu_id' 		=> $menu_id,
			'menu_active' 	=> 'Format Diskusi',
			'menu_open' 	=> 'Referensi',
			'path' 			=> $this->_path,
			'contents' 		=>  $this->_path . 'index',
			'script_js' 	=> $this->_path . 'js',
			// =================================================
			'breadcrumb' => ['Pengaturan', 'Referensi', 'Format Diskusi', 'index'],
			'modals' => [
	...
	public function data($menu_id = null)
	{
		...
		$output = $this->format_diskusi->datatables();
		response($output);
	}
...
/* End of file Format_diskusi.php */
