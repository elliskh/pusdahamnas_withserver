...
class Badan_hukum_model extends CI_Model
{
	private $_table = 'ref_badan_hukum';
	private $_column_order = [null, 'nama_badan',   null];
	private $_column_search = ['nama_badan',];
	private $_default_order = ['a.id_badan ' => 'ASC'];
	...
	public function datatables()
	{
		...
		foreach ($this->db->query($q)->result() as $field) {
			...
			$field->no = $no;
			//$field->id_badan = encrypt($field->id_badan);
