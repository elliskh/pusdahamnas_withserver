...
class Kategori_lembaga_model extends CI_Model
{
	private $_table = 'ref_kategori_lembaga';
	private $_column_order = [null, 'nama_kategori',   null];
	private $_column_search = ['nama_kategori',];
	private $_default_order = ['a.id_kategori ' => 'ASC'];
	...
	public function datatables()
	{
		...
		foreach ($this->db->query($q)->result() as $field) {
			...
			$field->no = $no;
			//$field->id_kategori = encrypt($field->id_kategori);
