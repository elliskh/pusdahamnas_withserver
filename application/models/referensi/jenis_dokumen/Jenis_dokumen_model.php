...
{
	private $_table = 'ref_jenis_dokumen';
	private $_column_order = [null, 'nama_jenis',   null];
	private $_column_search = ['nama_jenis',];
	private $_default_order = ['a.id_jenis ' => 'ASC'];
	...
	public function datatables()
	{
		...
		foreach ($this->db->query($q)->result() as $field) {
			...
			$field->no = $no;
			//$field->id_jenis = encrypt($field->id_jenis);
