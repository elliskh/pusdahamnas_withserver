...
class Isu_subyek_model extends CI_Model
{
	private $_table = 'ref_subyek_dokumen';
	private $_column_order = [null, 'nama_subyek',   null];
	private $_column_search = ['nama_subyek',];
	private $_default_order = ['a.id_subyek ' => 'ASC'];
	...
	public function datatables()
	{
		...
		foreach ($this->db->query($q)->result() as $field) {
			...
			$field->no = $no;
			//$field->id_subyek = encrypt($field->id_subyek);
