...
class Fokus_lembaga_model extends CI_Model
{
	private $_table = 'ref_fokus_lembaga';
	private $_column_order = [null, 'nama_fokus',   null];
	private $_column_search = ['nama_fokus',];
	private $_default_order = ['a.id_fokus ' => 'ASC'];
	...
	public function datatables()
	{
		...
		foreach ($this->db->query($q)->result() as $field) {
			...
			$field->no = $no;
			//$field->id_fokus = encrypt($field->id_fokus);
