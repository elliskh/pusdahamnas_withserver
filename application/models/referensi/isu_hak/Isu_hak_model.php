...
class Isu_hak_model extends CI_Model
{
	private $_table = 'ref_hak_dokumen';
	private $_column_order = [null, 'nama_hak',   null];
	private $_column_search = ['nama_hak',];
	private $_default_order = ['a.id_hak ' => 'ASC'];
