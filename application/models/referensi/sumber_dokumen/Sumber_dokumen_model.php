...
class Sumber_dokumen_model extends CI_Model
{
	private $_table = 'ref_sumber_dokumen';
	private $_column_order = [null, 'nama_sumber',   null];
	private $_column_search = ['nama_sumber',];
