...
class Format_diskusi_model extends CI_Model
{
	private $_table = 'ref_format_diskusi';
	private $_column_order = [null, 'nama_format',   null];
	private $_column_search = ['nama_format',];
	private $_default_order = ['a.id_format ' => 'ASC'];
	...
	public function datatables()
	{
		...
		foreach ($this->db->query($q)->result() as $field) {
			...
			$field->no = $no;
			//$field->id_format = encrypt($field->id_format);
