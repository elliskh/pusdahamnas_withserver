...
class Image_komunitasham_model extends CI_Model
{ 
	public $table = 'tb_image_komunitas_ham';
	public $column_order = [null, 'id','gambar','deskripsi','is_active', null, 'deleted_at'];
	public $column_search = ['deskripsi', 'is_active'];
	public $order = ['id' => 'asc'];

	private function _get_datatables_query()
	{
      $this->db->select("a.id, a.gambar, a.deskripsi, a.is_active, a.deleted_at, c.tipe_daftar");
      $this->db->from('tb_image_komunitas_ham a');      
