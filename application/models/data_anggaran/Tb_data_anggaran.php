...
class Tb_data_anggaran extends CI_Model
{
    var $column_order = array(null); //field yang ada di table user
    var $column_search = array('instansi'); //field yang diizin untuk pencarian 
    var $order = array('a.instansi' => 'asc'); // default order
