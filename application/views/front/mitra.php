                    ...
                    <div class="row">
                        <div class="col-lg-12" id="glossari_hasil_cari">
                            <div class="card" style="margin-top: 8%;">
                                <div class="card-body">
                                    <h4 class="card-title font-size-18 mb-3">Data Mitra</h4>
                                    ...
                                    <table class="table table-centered table-hover mb-0">
                                        <tbody>
                                            <?php foreach ($list_mitra as $list) { ?>
                                            <tr>
                                                <td>
                                                    <div class="d-md-flex">
                                                        <div class="table-content ml-md-3">
                                                            ...
                                                            <div class="mb-3">
                                                                <a href="<?= $list['link'] ?>" target="_blank"><p class="text-justify" style="color: blue;"><?= $list['link'] ?></p></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
