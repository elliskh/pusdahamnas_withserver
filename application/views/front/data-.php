  ...
  font-size:14px;
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Database Hak Asasi Manusiaa</li>
                                    </ol>
                                </div>
                                <?php
                                }
                    ...
                    <div class="card" style="margin-bottom: 15px;">
                        <div class="card-body">
                            ...
                            <p class="mb-0">Pencarian data, laporan, dokumen, dan ahli hak asasi manusiaa.</p>
                    ...
                    <div class="col-12" style="margin-left: -0.05%;float: left;">
                        <iframe width="100%;" height="650px;" src="https://lookerstudio.google.com/embed/reporting/76232793-d12d-49c8-8bad-a9ceaf4594a6/page/p_qnxk2gjg9c" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                    <!--<div class="col-12" style="margin-left: -0.05%;float: left;">
                        <iframe width="100%;" height="650px;" src="https://lookerstudio.google.com/embed/reporting/5efb3301-67eb-4a4a-b6cc-5dfc03d8a017/page/SAMdD?embed_domain=http://pusdahamnas.adhyamitra.com/" frameborder="0" style="border:0" allowfullscreen></iframe> 
                    </div>-->
                    <!-- end --> 
