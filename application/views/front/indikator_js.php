...
<script>
    var BASE_SITE = "http://localhost/pusdahamnas";///"https://pusdahamnas.komnasham.go.id";
    var URL_API_PESERTA = "http://localhost/pusdahamnas/home/get_json";//https://pusdahamnas.komnasham.go.id/home/get_json";
        ...
        return {
            ...
            tooltip: {
                ...
                formatter: function (dd) {
                    ...
                    if (!kt) return "";
                    var str = "<div><b>" + master.master.propinsi[dd.name] + "</b></div><div><b>Data Indikator HAM : </b></div>";
                    return (
                        kt.forEach(function (e, i) {
                            var k_kota = +e[0],
                                url = BASE_SITE + "/home/indikator/<?php echo md5(date("YmdHis"))?>" + e[2];
                                // url = '#';
