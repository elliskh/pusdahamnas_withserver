...
<script>
    ///var BASE_SITE = "https://pusdahamnas.komnasham.go.id";
    ///var URL_API_PESERTA = "http://devpusdahamnas.komnasham.go.id/home/get_json";    
    var BASE_SITE = "<?php echo base_url();?>";///https://pusdahamnas.komnasham.go.id";
    var URL_API_PESERTA = "<?php echo base_url('home/get_json');?>";//"http://devpusdahamnas.komnasham.go.id/home/get_json";
        ...
        return {
            ...
            tooltip: {
                ...
                formatter: function (dd) {
                    ...
                    if (!kt) return "";
                    var str = "<div><b>" + master.master.propinsi[dd.name] + "</b></div><div><b>Data Lembaga : </b></div>";
                    return (
                        kt.forEach(function (e, i) {
                            var k_kota = +e[0],
                                ///url = BASE_SITE + "/home/lembaga/<?php echo md5(date("YmdHis"))?>" + e[2];
                                url = BASE_SITE + "home/lembaga/<?php echo md5(date("YmdHis"))?>" + e[2];
                                // url = '#';
