  ...
  font-size:14px;
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?= base_url('home/anggaran_ham') ?>" method="POST">
                    ...
                    <tbody>
                                            ...
                                            <tr>             
                                              ...
                                              <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.0/jquery.min.js"></script>                           
                                                            <p><button id="toggle_all_<?=$list['id_anggaran']?>" class="btn btn-primary" type="button" data-toggle="collapse" aria-expanded="false" aria-controls="<?=$list['id_anggaran']?>">Detail >></button>
                                                              <div class="row">
                                                                <div class="col">
                                                                  <div class="collapse multi-collapse_<?=$list['id_anggaran']?>"  style="float: right;" id="<?=$list['id_anggaran']?>">        
                                                                        <?php 
                                                                            foreach ($this->db->where('id_anggaran',$list['id_anggaran'])->get('tb_anggaran_ham_detail')->result_array() as $row)
                                                                            {
                                                            ...
                                                            <script type="text/javascript">
                                                                ...
                                                                toggle_all.on('click', function(e) {
                                                                  ...
                                                                  if (toggle_all.attr("aria-expanded") === 'false') {
                                                                    $('.multi-collapse_<?=$list['id_data_snp']?>').collapse('show');                                                                    
                                                                    toggle_all.attr('aria-expanded', 'true'); 
                                                                    return false;                                                              
                                                                  } else {
                                                                    $('.multi-collapse_<?=$list['id_data_snp']?>').collapse('hide');
