                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo base_url()?>">Dataset Pusdahamnas</a></li>
                                        <li class="breadcrumb-item active"><?= $detail['nama_dokumen'] ?></li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-md-4 col-lg-2 ml-auto">
                                    <div class="card">
                                        <img class="" src="<?= ($detail2['gambar']!="") ? base_url('uploads/cover/'.$detail2['gambar'].'') : base_url('assets/noimage.png') ?>" alt="img-mitra">
