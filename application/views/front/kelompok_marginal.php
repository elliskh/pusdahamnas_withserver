      ...
      <div class="col-12">
        <div class="card" style="margin-top: 10%;">
          <div class="card-body pt-5 pb-5 pl-3 pr-3">
            <iframe id="isu4" name="isu4" class="" style="margin-right: -0.2%;float: right;margin-top: 5%;display:none" width="100%;" height="650px;" src="https://lookerstudio.google.com/embed/reporting/c0714ee0-44eb-4ec7-a5d0-8abab85fe489/page/p_8trcqmbr9c" frameborder="0" style="border:0" allowfullscreen></iframe>
...
<script type="text/javascript">
  ...
  document.getElementById('title_isu2').innerHTML = 'Kelompok marginal';
