...
<section class="blog-section rel z-1 pt-30 pb-100 rpb-100 rpb-150 rmb-30">
  ...
  <div class="container" id="src_snp" name="src_snp" style="margin-top:3%;display: none;">
    <div class="row">
      <div class="col-lg-12" id="snp_hasil_cari">
        <div class="card-body">
          <h6 class="card-title font-size-16">Pencarian Standar Norma & Pengaturan</h6>
          <form class="hero-search">
            <div class="position-relative">
              <input type="text" class="form-control" placeholder="Masukkan kata kunci" id="snp_cari_kata" value="">
                            ...
                            <table class="table table-striped table-bordered table-hover-" id="table-data-" style="width: 100%;">
                              <?php 
                                                                                                ...
                                                                                                $replaceStr = "<label style='background-color:#faefc2;'>" . $key_snp . "</label>";
                                                                                                 if(preg_match("/$key_snp/i", $row['deskripsi'])){ 
                                                                                               ?>
                                ...
                                <tr>
                                  ...
                                  <td colspan="6">
                                    <?php 
                                                                                                     ...
                                                                                                     foreach ($this->db->where('bab',$list['bab'])->order_by('id', 'asc')->get('tb_snp_detail')->result_array() as $row)
                                                                                                     { ?>
                                    <?php if(preg_match("/$key_snp/i", $row['deskripsi'])){?>
                                    ...
                                    <script type="text/javascript">
                                      var toggle_all = $('#toggle_all_<?=$row['
                                        id ']?>');
  ...
  <div class="container" id="src_dokumen" name="src_dokumen" style="margin-top:3%;display: none;">
    <div class="row">
  ...
  <div class="container" id="src_agenda" name="src_agenda" style="margin-top:3%;display: none;">
    <div class="row">
      <div class="col-lg-12" id="agenda_hasil_cari">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title font-size-18 mb-3">Hasil Pencarian </h4>
            <table class="table table-centered table-hover mb-0">
                ...
                <tr>
                  <td>
                    <div class="d-md-flex">
                      <div class="table-content ml-md-3">
                        <h4 class="font-weight-semibold limit-2-line-text mb-3">
                          <a class="link-underline link-title"><?= $value['judul'] ?></a>
                        </h4>
            ...
            <div class="container">
              <div class="row align-items-center justify-content-center">
                <div class="box-counter text-center swiper-wrapper">
                  ...
                  <div class="counter active wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInRight;">
                    ...
                    <h5 class="counter-number">
                      <span class="counter-timer text-primary" data-from="0" data-to="252">252</span></h5>
                    <h5 class="counter-title text-primary"><a href="<?= base_url('home/dokumen') ?>" class="text-primary">Dokumen HAM</a></h5>
                  </div>

                  <div class="counter active wow fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeInRight;">
                    <div class="counter-content">
                    ...
                    <h5 class="counter-number">
                      <span class="counter-timer text-primary" data-from="0" data-to="859">859</span></h5>
                    <h5 class="counter-title text-primary"><a href="<?= base_url('home/data_snp') ?>" class="text-primary">Standar Norma & Pengaturan</a></h5>
                  </div>

                  <div class="counter active wow fadeInRight" data-wow-delay="600ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 600ms; animation-name: fadeInRight;">
                    <div class="counter-content">
                    ...
                    <h5 class="counter-number">
                      <span class="counter-timer text-primary" data-from="0" data-to="1203">1203</span></h5>
                    <h5 class="counter-title text-primary"><a href="<?= base_url('home/glossary') ?>" class="text-primary">Glosarium HAM</a></h5>
                  </div>

                  <div class="counter active wow fadeInRight" data-wow-delay="900ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 900ms; animation-name: fadeInRight;">
                    <div class="counter-content">
                    ...
                    <h5 class="counter-number">
                      <span class="counter-timer text-primary" data-from="0" data-to="453">453</span></h5>
                  ...
                  <div class="counter active wow fadeInRight" data-wow-delay="900ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 900ms; animation-name: fadeInRight;">
                    ...
                    <h5 class="counter-number">
                      <span class="counter-timer text-primary" data-from="0" data-to="57">57</span></h5>
                  ...
                  <div class="counter active wow fadeInRight" data-wow-delay="900ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 900ms; animation-name: fadeInRight;">
                    ...
                    <h5 class="counter-number">
                      <span class="counter-timer text-primary" data-from="0" data-to="57">99</span></h5>
                    <h5 class="counter-title text-primary"><a href="#" class="text-primary">Mitra HAM</a></h5>
                  </div>
