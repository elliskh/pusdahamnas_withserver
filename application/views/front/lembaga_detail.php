<script src='https://www.google.com/recaptcha/api.js'></script>
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo base_url('home/lembaga')?>">Lembaga HAM</a></li>
                                        <li class="breadcrumb-item active">Detail Lembaga</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-9 mx-auto">
                            <div class="card card-detail" style="margin-bottom: 15px;margin-top: 8%;">
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                        <div class="col-md-8 col-lg-12">
                                            <div>
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <img class="img-fluid img-cover" src="<?php echo base_url('assets/noimage.png')?>" alt="img-mitra">
                                                    </div>
                                                ...
                                                <div class="text-justify">
                                                    ...
                                                    <div class="mt-5">
                                                        ...
                                                        <div>
                                                            <ul class="pl-4">
                                                                <?php
                                                                $where = "id_lembaga != $detail[id_lembaga] AND deleted_at is null";
                                                                ...
                                                                foreach ($this->db->where('prop_lembaga',$detail['prop_lembaga'])->where($where)->get('tb_lembaga',5)->result_array() as $rr)
                                                                {
                                                                    ?>
                                                                <li class="py-1">
                                                                    <a class="link-underline" style="color: black;" href="<?php echo base_url('home/lembaga/'.md5(date("YmdHis")).$rr['id_lembaga'].'')?>"><?php echo $rr['nama_lembaga']?></a>
                                                                </li>
                                                                    <?php
                                                                }
                                                                ?>
