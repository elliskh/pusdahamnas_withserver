...
<footer class="landing-footer">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-4 col-lg-4 ml-auto">
                <div class="mb-4 mb-lg-0">
                    <h5 class="mb-3 footer-list-title">Link Terkait</h5>
                    <ul class="list-unstyled footer-list-menu">
                        <li><a href="https://www.komnasham.go.id/" target="_blank">Website Komnas HAM</a></li>
                        <?php
            ...
            <div class="col-sm-4 col-lg-4 ml-auto">
                <div class="mb-4 mb-lg-0">
                    <h5 class="mb-3 footer-list-title">Link Mitra</h5>
                    <ul class="list-unstyled footer-list-menu">
