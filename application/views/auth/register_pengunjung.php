							...
							<div class="card">
								<div class="card-body">
									<div class="display_form_registrasi">
										...
										<form id="form-register-pengunjung"
											action="<?= site_url('auth/processRegAPI') ?>" method="post"
											autocomplete="off">
											<input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>"
												value="<?= $this->security->get_csrf_hash(); ?>" style="display: none">
											<div class="row mt-1 mb-1">
												<div class="col-md-6 col-sm-8">
													<h4> Form Pendaftaran Pengunjung</h4>
												</div>
											...
											<div class="form-group input-group">
												...
												<input id="name" name="name" class="form-control" style="height: 15px;"
													placeholder="Nama Panjang" type="text" value="" required=""
													autofocus>
											</div>
											<div class="form-group input-group">
												<div class="input-group-prepend">
												...
												<input id="lembaga_instansi" name="lembaga_instansi"
													class="form-control" style="height: 15px;"
													placeholder="Lembaga/Instansi" value="" type="text" required="">
											</div>
											<div class="form-group input-group">
												<div class="input-group-prepend">
												...
												<input id="email" name="email" class="form-control"
													style="height: 15px;" placeholder="Alamat Email" type="email"
													autocomplete="off" required="">
												<input id="pendidikan" name="pendidikan" class="form-control"
													style="height: 15px;" value="" type="hidden">
											</div>
											<div class="form-group input-group">
												<div class="input-group-prepend">
													<span class="input-group-text"> <i class="fa fa-user"></i> </span>
												...
												<input id="username" name="username" class="form-control"
													onchange="checkUser()" style="height: 15px;"
													placeholder="User pengguna" type="text" required="">
												<input id="tipe_daftar" name="tipe_daftar" class="form-control"
													style="height: 15px;" type="hidden" value="1">
											</div>
											<div class="form-group input-group">
												<div class="input-group-prepend">
												...
												<input id="input-password" name="password" class="form-control"
													style="height: 15px;" placeholder="Masukkan kata sandi" value=""
													type="password" required="" min="8">
												<div class="input-group-prepend">
													<span id="show-password" class="input-group-text"> <i
											...
											<div class="form-group input-group">
												...
												<input id="input-password2" name="password2" class="form-control"
													style="height: 15px;" placeholder="Ulang kata sandi" value=""
													type="password" required="" min="8">
												<input type="hidden" class="form-control" name="gambar" id="gambar"
													value="">
												<div class="input-group-prepend">
													<span id="show-password2" class="input-group-text"> <i
															class="fa fa-eye-slash"></i> </span>
													<span id='message_password2'></span>
												</div>
											</div>
											<div class="d-flex mb-5 align-items-center">
												<label class="control control--checkbox mb-3 mb-sm-0"><span
														class="caption">Setujui Syarat dan <a href="#">Ketentuan
															kami</a></span>
											...
											<div class="form-group">
												<button id="btn_register_pengunjung" form="form-register-pengunjung"
													type="submit" class="btn btn-primary btn-block"><i
														class="bx bx-check-circle"></i> Daftar </button>
											</div>
											<p class="text-center">Sudah memiliki akun? <a
													href="<?= base_url('home/login') ?>" style="color: blue;">Masuk</a>
											</p>
										</form>
									</div>
