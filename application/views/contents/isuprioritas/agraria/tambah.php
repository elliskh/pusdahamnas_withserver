		...
		<div class="card">
			<div class="card-body">
				<div class="display_form_registrasi">
					<form class="form form-horizontal" action="<?php echo base_url('isuprioritas/agraria/simpan')?>" enctype='multipart/form-data' method="POST" autocomplete="off">
							...
							<div class="row mt-1 mb-1">
								...
								<div class="col-md-6 col-sm-4">
									<div class="text-right">
										<a href="<?=base_url('isuprioritas/agraria/index/'.$menu_id)?>" class="btn btn-link text-right">
