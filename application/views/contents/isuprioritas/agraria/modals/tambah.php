			...
			<div class="modal-body">
				<form id="form-tambah" enctype="multipart/form-data">
					<div class="form-group">
						...
						<input type="text" name="nama_lembaga" id="tambah-nama" class="form-control" autocomplete="off" placeholder="Masukkan nama">
					</div>
					<div class="form-group">
						<label for="tambah-nama">Singkatan <span class="text-danger">*)</span></label>
						<input type="text" name="singkatan_lembaga" id="tambah-singkatan" class="form-control" autocomplete="off" placeholder="Masukkan singkatan">
					</div>
				</form>
			</div>
