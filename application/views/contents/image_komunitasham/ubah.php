		...
		<div class="card">
			<div class="card-body">
				<div class="display_form_registrasi">
					<form id="form-edit-image" class="form form-horizontal" action="<?php echo base_url('image_komunitasham/edit_update');?>" enctype='multipart/form-data'  method="POST">
...
<script type="text/javascript">
    ...
    //alert(data);    
		$.ajax({
  	        url: "<?php echo base_url('image_komunitasham/edit_update');?>",//$(this).prop('action'),
	 		type: "POST",
