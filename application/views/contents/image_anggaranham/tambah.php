		...
		<div class="card">
			<div class="card-body">
				<div class="display_form_registrasi">
					<form id="form-add-gbr-dokumen" class="form form-horizontal" action="<?php echo base_url('image_anggaranham/simpan');?>"  method="POST" enctype='multipart/form-data' autocomplete="off">
					<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
						<div class="form-body">
							<div class="row mt-1 mb-1">
								...
								<div class="col-md-6 col-sm-4">
									<div class="text-right">
										<a href="<?=base_url('image_anggaranham/index/'.$menu_id)?>" class="btn btn-link text-right">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
                                    <input type="text" class="form-control" id="menu_id" name="menu_id"  value="<?= $menu_id?>" hidden>
...
<script type="text/javascript">
    ...
    alert(data);    
		$.ajax({
  	        url: "<?php echo base_url('image_anggaran_ham/simpan');?>",//$(this).prop('action'),
	 		type: "POST",
			data: data, 
			dataType: 'json',
			processData: false,
