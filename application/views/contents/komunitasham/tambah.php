					...
					<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
						<div class="form-body">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<input type="text" class="form-control" name="sumberdata" placeholder="Sumber data"  value="" required="">
		...
		$.ajax({
			...
			success: (res) => {
				...
				if (res.status=='sukses') {
				    ...
				    alert("Terima kasih, Konten anda akan di lakukan review terlebih dahulu");history.go(-1);
                    //location.reload()
