		...
		<div class="card">
			<div class="card-body">
				<div class="display_form_registrasi">
					<form id="form-add-gbr-dokumen" class="form form-horizontal" action="<?php echo base_url('image_visualisasi/simpan');?>"  method="POST" enctype='multipart/form-data' autocomplete="off">
							...
							<div class="row mt-1 mb-1">
								...
								<div class="col-md-6 col-sm-4">
									<div class="text-right">
										<a href="<?=base_url('image_visualisasi/index/'.$menu_id)?>" class="btn btn-link text-right">
...
<script type="text/javascript">
    ...
    alert(data);    
		$.ajax({
  	        url: "<?php echo base_url('image_visualisasi/simpan');?>",//$(this).prop('action'),
	 		type: "POST",
			data: data, 
			dataType: 'json',
			processData: false,
