		...
		<div class="card">
			<div class="card-body">
				<div class="display_form_registrasi">
					<form id="form-add-gbr-dokumen" class="form form-horizontal" action="<?php echo base_url('image_dokumen/simpan');?>"  method="POST" enctype='multipart/form-data' autocomplete="off">
					<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
						<div class="form-body">
							<div class="row mt-1 mb-1">
								<div class="col-md-6 col-sm-8">
									<h4> Form Gambar Dokumen</h4>
								</div>
								<div class="col-md-6 col-sm-4">
									<div class="text-right">
										<a href="<?=base_url('image_dokumen/index/'.$menu_id)?>" class="btn btn-link text-right">
...
<script type="text/javascript">
    ...
    alert(data);    
		$.ajax({
  	        url: "<?php echo base_url('image_dokumen/simpan');?>",//$(this).prop('action'),
	 		type: "POST",
			data: data, 
			dataType: 'json',
			processData: false,
