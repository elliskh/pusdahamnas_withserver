			...
			<div class="modal-body">
				<form id="form-ubah" enctype="multipart/form-data">
					<div class="form-group">
						...
						<input type="text" name="nama" id="ubah-nama" class="form-control" autocomplete="off" placeholder="Masukkan nama group menu">
					</div>
					<div class="form-group">
						<label for="ubah-urutan">Urutan <span class="text-danger">*)</span></label>
						<input type="text" name="urutan" id="ubah-urutan" class="form-control" autocomplete="off" placeholder="Masukkan urutan group menu">
					</div>
				</form>
			</div>
