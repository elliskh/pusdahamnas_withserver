			...
			<div class="modal-body">
				<form id="form-ubah" enctype="multipart/form-data">
					<div class="form-group" hidden>
						<label for="ubah-id"> ID </label>
						<input type="text" name="id" id="ubah-id" class="form-control">
					</div>
					<div class="form-group">
						<label for="ubah-nama">Nama <span class="text-danger">*)</span></label>
						<input type="text" name="nama" id="ubah-nama" class="form-control" autocomplete="off" placeholder="Masukkan Nama Lembaga">
					</div>
					<div class="form-group">
						<label for="ubah-singkatan">Singkatan Lembaga <span class="text-danger">*)</span></label>
						<input type="text" name="singkatan" id="ubah-singkatan" class="form-control" autocomplete="off" placeholder="Masukkan Singkatan Lembaga">
					</div>
				</form>
			</div>
