			...
			<div class="modal-body">
				<form id="form-tambah" enctype="multipart/form-data">
					<div class="form-group">
						...
						<input type="text" name="nama" id="tambah-nama" class="form-control" autocomplete="off" placeholder="Masukkan nama lembaga">
					</div>
					<div class="form-group">
						<label for="tambah-singkatan">Singkatan Lembaga <span class="text-danger">*)</span></label>
						<input type="text" name="singkatan" id="tambah-singkatan" class="form-control" autocomplete="off" placeholder="Masukkan nama singkatan lembaga">
					</div>
				</form>
			</div>
