						...
						<div class="form-body">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									...
									<input type="text" class="form-control" name="bab" placeholder="Nama BAB" value="<?=$data['detail']['bab']?>" required="">
...
<script type="text/javascript">
	...
	//	data.append(CSRF.token_name, CSRF.hash);
		...
		$.ajax({
  	        url: "<?php echo base_url('audit_ham/detail_update');?>",//$(this).prop('action'),
	 		type: "POST",
			data: data, 
			dataType: 'json',
			processData: false,
