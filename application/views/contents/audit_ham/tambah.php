					...
					<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
						<div class="form-body">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<input type="text" class="form-control" name="nama_audit" placeholder="Nama Dokumen Audit"  value="" required="">
									<span class="validasi"></span>
								</div>
							</div>
							<div class="row mb-3">
...
<script type="text/javascript">
    ...
    //alert(data);    
		$.ajax({
  	        url: "<?php echo base_url('audit_ham/simpan');?>",//$(this).prop('action'),
	 		type: "POST",
			data: data, 
			dataType: 'json',
			processData: false,
