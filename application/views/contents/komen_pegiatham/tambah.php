		...
		<div class="card">
			<div class="card-body">
				<div class="display_form_registrasi">
					<form id="form-add-konten" class="form form-horizontal" action="<?=base_url('komunitasham/simpan')?>"  method="POST" autocomplete="off">
						...
						<div class="form-body">
							<div class="row mt-1 mb-1">
								...
								<div class="col-md-6 col-sm-4">
									<div class="text-right">
										<a href="<?=base_url('komunitasham/index/'.$menu_id)?>" class="btn btn-link text-right">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									...
									<input type="text" class="form-control" name="judul" placeholder="Judul" value="ssssssss" required="">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<input type="text" class="form-control" name="deskripsi" placeholder="Deskripsi"  value="aaaaaaaaaaaaaa" required="">
									<span class="validasi"></span>
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<input type="text" class="form-control" name="penulis" placeholder="Nama Penulis"  value="eeeeeeeee" required="">
									<span class="validasi"></span>
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<input type="text" class="form-control" name="editor" placeholder="Nama Editor"  value="rrrrrrrrrrrrrrr" required="">
									<span class="validasi"></span>
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<input type="text" class="form-control" name="sumberdata" placeholder="Sumber data"  value="ggggggggggg" required="">
									<span class="validasi"></span>
								</div>
							</div>
							...
							<div class="row mb-3">
								<div class="col-md-12 d-flex justify-content-center ">
									<button id="addKonten" form="form-add-konten" type="submit" class="btn btn-lg btn-primary mr-1 mb-1 mt-5 btn-block w-50"> <i class="bx bx-check-circle"></i> Simpan</button>
								</div>
