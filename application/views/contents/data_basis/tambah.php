		...
		<div class="card">
			<div class="card-body">
				<div class="display_form_registrasi">
					<form class="form form-horizontal" action="<?=base_url('data_basis/simpan')?>" enctype='multipart/form-data' method="POST" autocomplete="off">
						...
						<div class="form-body">
							<div class="row mt-1 mb-1">
								...
								<div class="col-md-6 col-sm-4">
									<div class="text-right">
										<a href="<?=base_url('data_basis/index/'.$menu_id)?>" class="btn btn-link text-right">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									...
									<select name="unit_kerja" class="form-control select2" required>
										<option value="" disabled selected>Pilih Unit Kerja</option>
										<?php foreach ($this->db->where('is_active','1')->get('ref_unitkerja')->result() as $value) { ?>
											<option value="<?php echo $value->nama_unit?>" <?=@$data->unit_kerja==$value->nama_unit?'selected':''?>><?=$value->nama_unit?></option>
										<?php } ?>
									</select>
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<input type="number" class="form-control" name="tahun" placeholder="Tahun"  value="<?=@$data->tahun?>" required>
									<span class="validasi"></span>
								</div>
							</div>
							<div class="row mb-3">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<select name="id_jenis_dokumen" class="form-control select2" required>
										<option value="" disabled selected>Pilih</option>
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									...
									{
										?>
										<div class="note">File Tersimpan : <a target='_blank' href='<?php echo base_url('uploads/cover_internal/'.@$data->gambar.'')?>'><?php echo @$data->gambar ?></a></div>
										<?php
									}
									?>
								</div>
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<input type="text" class="form-control" name="pic_input" value="<?=@$data->pic_input?>" placeholder="Masukkan PIC Input">
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-md-2">
							...
							<div class="row mb-3" id="dokumen_upload" style="display:none;">
								...
								<?php
									...
									{
										?>
										<div class="note">File Tersimpan : <a target='_blank' href='<?php echo base_url('uploads/dokumen_internal/'.@$data->id.'/'.@$data->file_name.'')?>'><?php echo @$data->orig_name ?></a></div>
										<?php
									}
									?>
								</div>
