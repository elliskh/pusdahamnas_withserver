			...
			<div class="row align-items-center mb-4">
									...
									<select name="id_unit_kerja" id="id_unit_kerja" class="form-control select2" >
										...
										<?php foreach ($unit as $key => $value) { ?>
											<option value="<?=$value->nama_unit?>"><?=$value->nama_unit?></option>
										<?php } ?>
									</select>
                                                </div>
                                            </div>
									...
									<select name="id_lembaga" id="id_lembaga" class="form-control select2" >
										<option value="all" selected>Semua Jenis Dokumen</option>
										<?php foreach ($jenis as $key => $value) { ?>
											<option value="<?=encode_id($value->id_jenis)?>"><?=$value->nama_jenis?></option>
										<?php } ?>
									</select>
                                                </div>
                                            </div>
