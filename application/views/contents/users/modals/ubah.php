			...
			<div class="modal-body">
				<form action="<?= site_url('users/update/' . $menu_id) ?>" method="post" id="form-ubah-user">
					...
					<div class="form-group">
						...
						<input type="text" name="username" id="ubah-username" class="form-control" placeholder="Masukkan username">
					</div>
					<div class="form-group">
						<label for="ubah-nama">Nama Lengkap <span class="text-danger">*</span></label>
						<input type="text" name="nama" id="ubah-nama" class="form-control" placeholder="Masukkan nama lengkap">
					</div>
					<div class="form-group">
						<label for="ubah-email">Nama Email <span class="text-danger">*</span></label>
						<input type="text" name="email" id="ubah-email" class="form-control" placeholder="Masukkan Email">
					</div>
				</form>
			</div>
