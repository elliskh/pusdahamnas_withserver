								...
								<div class="col-md-10">
									<select name="status_person" class="form-control select2" >
										<option value="" disabled selected>Pilih</option>
                                           ...
                                           <?php 
                                           $slc = "";
                                           if($value->status_person=='akademisi'){
                                              $slc = "selected";
                                           }elseif($value->status_person=='praktisi'){
                                              $slc = "selected";
                                           }elseif($value->status_person=='peneliti'){
                                              $slc = "selected";
                                           }else{
                                              $slc = "";
                                           }?>
									...
									<select name="pendidikan" class="form-control select2" >
										<option value="" disabled selected>Pilih</option>
                                           ...
                                           if($value->pendidikan=='SMA'){
											...
											<option value="s1" <?php echo $slc; ?>>S2</option>
