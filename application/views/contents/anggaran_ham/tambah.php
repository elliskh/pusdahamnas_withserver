		...
		<div class="card">
			<div class="card-body">
				<div class="display_form_registrasi">
					<form id="form-add-konten" class="form form-horizontal" action="#"  method="POST" autocomplete="off">
					<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
						<div class="form-body">
							<div class="row mt-1 mb-1">
								<div class="col-md-6 col-sm-8">
									<h4> Form Anggaran HAM</h4>
								</div>
								...
								<div class="col-md-10">
									...
									<input type="text" class="form-control" name="instansi" placeholder="Nama instansi" value="" required="">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<input type="text" class="form-control" name="nama_anggaran" placeholder="Nama anggaran"  value="" required="">
									<span class="validasi"></span>
								</div>
							</div>
							<div class="row mb-3">
...
<script type="text/javascript">
    ...
    //alert(data);    
		$.ajax({
  	        url: "<?php echo base_url('anggaran_ham/simpan');?>",//$(this).prop('action'),
	 		type: "POST",
			data: data, 
			dataType: 'json',
			processData: false,
			...
			//	table.ajax.reload();
             ...
             error: (res) => {//alert("Terjadi kesalahan di server3!");
              if(JSON.stringify(res.status)==500){
                ...
                alert("Tambah data berhasil");history.go(-1);
              }
			/*error: (res) => {
                alert("Terjadi kesalahan di server!");
