					...
					<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
						<div class="form-body">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<input type="text" class="form-control" name="nama_anggaran" placeholder="Nama anggaran"  value="<?=$data['detail']['nama_anggaran']?>" required="">
									<span class="validasi"></span>
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-md-2">
									<label>Deskripsi Nama Anggaran</label>
								</div>
                                <div class="col-md-10">
...
<script type="text/javascript">
	...
	//	data.append(CSRF.token_name, CSRF.hash);
		...
		$.ajax({
  	        url: "<?php echo base_url('anggaran_ham/update');?>",//$(this).prop('action'),
	 		type: "POST",
			data: data, 
			dataType: 'json',
			processData: false,
