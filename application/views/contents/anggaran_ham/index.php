	...
	<div class="col-12">
		<div class="card rounded-pill-top">
			<div class="card-header bg-theme-custom-dark rounded-pill-top">
				<h2 class="mb-0 text-white font-weight-bold"><i class="bx bx-book"></i>Anggaran Ramah HAM</h2>
				<h5 class="mb-0 text-white">Data Anggaran Ramah HAM </h5>
			</div>
			<div class="card-body">
				<div class="row mb-2">
                  <?php 
            ...
            <th>Column 3</th>
                        ...
                        <thead class="bg-theme-custom-dark bg-custom-thead text-white">
                            <tr>
								...
								<th>Nama Instansi</th>
								<th>Nama anggaran</th>
								<th>Deskripsi Tentang Anggaran</th>
								<th>Status publik</th>
