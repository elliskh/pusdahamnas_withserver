									...
									<div class="text-right">
										<a href="#" onclick="history.go(-1)" class="btn btn-link text-right">
											<i class="bx bx-left-arrow-circle"></i> Kembali</a>
														...
														<div class="row mb-3">
								<div class="col-md-2">
									<label>Nama SNP</label>
								</div>
								<div class="col-md-10">
									<input type="text" class="form-control" value="" name="menu_id" hidden>
									<input type="text" class="form-control" id="judul" name="judul" placeholder="Nama SNP" value="" required="">
...
<script type="text/javascript">
    ...
    //alert(data);    
		$.ajax({
  	        url: "<?php echo base_url('snp/ras_etnis/simpan');?>",//$(this).prop('action'),
	 		type: "POST",
			data: data, 
			dataType: 'json',
			processData: false,
			...
			success: (res) => {
				...
				if (res.status=='sukses') {
                    ...
                    //location.reload()
					//toastrSuccess('success_messages', "Tambah data berhasil");
			...
			//	table.ajax.reload();
             ...
             error: (res) => {//alert("Terjadi kesalahan di server3!");
              if(JSON.stringify(res.status)==500){
                ...
                alert("Berhasil simpan dataa");history.go(-1);
