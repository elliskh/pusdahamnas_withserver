        ...
        <div class="card">
            <div class="card-body">
                <div class="display_form_registrasi">
                    <form id="form-add-detail" class="form form-horizontal" action="#" method="POST" autocomplete="off">
                        <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                        <div class="form-body">
                            <div class="row mt-1 mb-1">
                                <div class="col-md-6 col-sm-8">
                                    <h4> Form Detail SNP</h4>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="text" class="form-control" value="<?= $menu_id;?>" name="id" hidden>
                                    <input type="text" class="form-control" name="bab" placeholder="Nama BAB" value="" required="">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10">
                                    <input type="text" id="nomor_halaman" name="nomor_halaman" class="form-control" required="">
                                    <input type="hidden" id="nomor_paragraf" name="nomor_paragraf" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    <textarea id="deskripsi" name="deskripsi" class="form-control" style="min-height:40vh" required=""></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-2">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 d-flex justify-content-center ">
                                    <button form="form-add-detail" type="submit" class="btn btn-lg btn-primary mr-1 mb-1 mt-5 btn-block w-50"> <i class="bx bx-check-circle"></i> Simpan</button>
                                </div>
...
<script type="text/javascript">
    $('#form-add-detail').on('submit', function (e) {
        ...
        //alert(data);    
        $.ajax({
            url: "<?php echo base_url('snp/ras_etnis/detail_simpan');?>", //$(this).prop('action'),
            type: "POST",
            data: data,
            dataType: 'json',
            processData: false,
