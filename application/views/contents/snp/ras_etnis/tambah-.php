		...
		<div class="card">
			<div class="card-body">
				<div class="display_form_registrasi">
					<form class="form form-horizontal" action="<?php echo base_url('snp/ras_etnis/simpan')?>" enctype='multipart/form-data' method="POST" autocomplete="off">
					<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
						<div class="form-body">
							<div class="row mt-1 mb-1">
								<div class="col-md-6 col-sm-8">
									<h4> Form Ras Etnis</h4>
								</div>
								<div class="col-md-6 col-sm-4">
									<div class="text-right">
										<a href="<?=base_url('snp/ras_etnis/index/'.$menu_id)?>" class="btn btn-link text-right">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<input type="text" class="form-control" name="jml_paragraf" placeholder="Jumlah Paragraf" value="<?=@$data->jml_paragraf?>" required>
									<span class="validasi"></span>
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									<textarea class="form-control" name="deskripsi" placeholder="Masukkan Deskripsi" rows="15"><?=@$data->deskripsi?></textarea>
									<span class="validasi"></span>
								</div>
							</div>
