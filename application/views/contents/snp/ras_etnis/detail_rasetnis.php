	...
	<div class="col-12">
		<div class="card rounded-pill-top">
			<div class="card-header bg-theme-custom-dark rounded-pill-top">
				<h2 class="mb-0 text-white font-weight-bold"><i class="bx bx-book"></i><?php echo $data['detail']['judul'];?><?php //echo "(".$data['detail']['instansi'].")";?></h2>
			</div>
			<div class="card-body">
				<div class="row mb-2">
                  <?php 
					...
					<div class="col-sm-12">
						<div class="text-right mb-3">
							...
							<a class="btn bg-theme-custom text-white btn-rounded waves-effect waves-light btn-tambah" href="<?= '' . $link . '/' . $menu_id . '' ?>">
								<i class="bx bx-plus-circle"></i> Tambah Bab
							</a>
						</div>
					</div>
                 <?php }?>   
