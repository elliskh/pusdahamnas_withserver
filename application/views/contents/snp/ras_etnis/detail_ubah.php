		...
		<div class="card">
			<div class="card-body">
				<div class="display_form_registrasi">
					<form id="form-edit-anggaranham" class="form form-horizontal" action="#"  method="POST" autocomplete="off">
					<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
						<div class="form-body">
							<div class="row mt-1 mb-1">
								<div class="col-md-6 col-sm-8">
									<h4> Form Detail Anggaran Ramah HAM</h4>
								</div>
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									...
									<input type="text" class="form-control" id="bab" name="bab" placeholder="Nama BAB" value="<?=$data['detail']['bab']?>" required="">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
                                    <input type="text" id="nomor_halaman" name="nomor_halaman" class="form-control" value="<?=$data['detail']['nomor_halaman']?>" required="">
                                    <input type="hidden" id="nomor_paragraf" name="nomor_paragraf" class="form-control" value="<?=$data['detail']['nomor_paragraf']?>">
                                </div>
                            </div>
							<div class="row mb-3">
								<div class="col-md-2">
							...
							<div class="row mb-3">
								<div class="col-md-12 d-flex justify-content-center ">
									<button form="form-edit-anggaranham" type="submit" class="btn btn-lg btn-primary mr-1 mb-1 mt-5 btn-block w-50"> <i class="bx bx-check-circle"></i> Simpan</button>
								</div>
...
<script type="text/javascript">
	$('#form-edit-anggaranham').on('submit', function (e) {
		e.preventDefault();
	...
	//	data.append(CSRF.token_name, CSRF.hash);
		...
		$.ajax({
  	        url: "<?php echo base_url('snp/ras_etnis/detail_update');?>",//$(this).prop('action'),
	 		type: "POST",
			data: data, 
			dataType: 'json',
			processData: false,
