						...
						<div class="form-body">
							...
							<div class="row mb-3">
								...
								<div class="col-md-10">
									...
									<input type="text" class="form-control" id="judul" name="judul" placeholder="Nama" value="<?=$data['detail']['judul']?>" required="">
...
<script type="text/javascript">
	...
	//	data.append(CSRF.token_name, CSRF.hash);
		...
		$.ajax({
  	        url: "<?php echo base_url('snp/ras_etnis/update');?>",//$(this).prop('action'),
	 		type: "POST",
			data: data, 
			dataType: 'json',
			processData: false,
